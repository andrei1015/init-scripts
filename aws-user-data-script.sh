...
echo "alias ncdu='ncdu -q --confirm-quit --disable-delete --disable-shell --color dark'"  >>  /home/arch/.bashrc
...
echo "export PS1='\[\e[0m\][\[\e[0;31m\]\u \[\e[0m\]@ \[\e[0;92m\]\w \[\e[0m\]@ \[\e[0;35m\]\t\[\e[0m\]] \[\e[0;97m\]\$ \[\e[0m\]'"  >>  /home/arch/.bashrc
...
echo "export HISTSIZE=20000"  >>  /home/arch/.bashrc
